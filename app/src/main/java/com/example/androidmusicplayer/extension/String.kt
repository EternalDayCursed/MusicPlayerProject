...
import com.example.androidmusicplayer.helper.extensionsSupportingEXIF
import com.example.androidmusicplayer.helper.normalizeRegex
import java.io.File
...
fun String.getBasePath(context: Context): String {
    return when {
        startsWith(context.internalStoragePathFromConfig) -> context.internalStoragePathFromConfig
...
fun String.isMediaFile() = isGif()|| isSvg() || isPortrait()
