...
import com.example.androidmusicplayer.databinding.FilepickerFavoriteBinding
...
class FilepickerFavoritesAdapter(
    activity: BaseCustomActivity, val paths: List<String>, recyclerView: MyRecyclerView,
    itemClick: (Any) -> Unit
