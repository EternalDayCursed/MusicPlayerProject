...
import com.example.androidmusicplayer.myclasses.MyActionModeCallback
import com.example.androidmusicplayer.views.MyRecyclerView
import kotlin.math.max
import kotlin.math.min

abstract class MyRecyclerViewAdapter(val activity: BaseCustomActivity, val recyclerView: MyRecyclerView, val itemClick: (Any) -> Unit) :
