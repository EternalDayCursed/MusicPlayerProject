...
import com.example.androidmusicplayer.databinding.DialogRadioGroupBinding
import com.example.androidmusicplayer.databinding.RadioButtonBinding
import com.example.androidmusicplayer.extension.getAlertDialogBuilder
import com.example.androidmusicplayer.extension.getBasePath
import com.example.androidmusicplayer.extension.hasExternalSDCard
import com.example.androidmusicplayer.extension.hasOTGConnected
import com.example.androidmusicplayer.extension.internalStoragePathFromConfig
import com.example.androidmusicplayer.extension.otgPath
...
class StoragePickerDialog(
    val activity: BaseCustomActivity, val currPath: String, val showRoot: Boolean, pickSingleOption: Boolean,
    ...
    init {
        availableStorages.add(activity.internalStoragePathFromConfig)
        when {
    ...
    private fun initDialog() {
        ...
        internalButton.apply {
            ...
            isChecked = basePath == context.internalStoragePathFromConfig
    ...
    private fun internalPicked() {
        dialog?.dismiss()
        callback(activity.internalStoragePathFromConfig)
    }
