...
import com.example.androidmusicplayer.dialog.ConfirmationAdvancedDialog
import com.example.androidmusicplayer.dialog.ConfirmationDialog
import com.example.androidmusicplayer.dialog.ExportSettingsDialog
import com.example.androidmusicplayer.dialog.FileConflictDialog
import com.example.androidmusicplayer.dialog.PermissionRequiredDialog
import com.example.androidmusicplayer.dialog.WritePermissionDialog
...
import com.example.androidmusicplayer.extension.buildDocumentUriSdk30
import com.example.androidmusicplayer.extension.canManageMedia
import com.example.androidmusicplayer.extension.createAndroidDataOrObbPath
import com.example.androidmusicplayer.extension.createAndroidDataOrObbUri
import com.example.androidmusicplayer.extension.createAndroidSAFFile
import com.example.androidmusicplayer.extension.createDocumentUriUsingFirstParentTreeUri
import com.example.androidmusicplayer.extension.createFirstParentTreeUri
import com.example.androidmusicplayer.extension.createFirstParentTreeUriUsingRootTree
import com.example.androidmusicplayer.extension.createSAFFileSdk30
import com.example.androidmusicplayer.extension.deleteFromMediaStore
import com.example.androidmusicplayer.extension.formatSize
import com.example.androidmusicplayer.extension.getAndroidSAFUri
import com.example.androidmusicplayer.extension.getAndroidTreeUri
import com.example.androidmusicplayer.extension.getAppIconColors
import com.example.androidmusicplayer.extension.getAvailableStorageB
import com.example.androidmusicplayer.extension.getColoredDrawableWithColor
import com.example.androidmusicplayer.extension.getColoredMaterialStatusBarColor
...
import com.example.androidmusicplayer.extension.getFileUrisFromFileDirItems
import com.example.androidmusicplayer.extension.getFilenameFromPath
import com.example.androidmusicplayer.extension.getFirstParentLevel
import com.example.androidmusicplayer.extension.getFirstParentPath
import com.example.androidmusicplayer.extension.getParentPath
import com.example.androidmusicplayer.extension.getPermissionString
import com.example.androidmusicplayer.extension.getProperBackgroundColor
import com.example.androidmusicplayer.extension.getProperStatusBarColor
import com.example.androidmusicplayer.extension.getThemeId
import com.example.androidmusicplayer.extension.hasAllPermissions
import com.example.androidmusicplayer.extension.hasPermission
import com.example.androidmusicplayer.extension.hasProperStoredAndroidTreeUri
import com.example.androidmusicplayer.extension.hasProperStoredDocumentUriSdk30
import com.example.androidmusicplayer.extension.hasProperStoredFirstParentUri
import com.example.androidmusicplayer.extension.hasProperStoredTreeUri
...
import com.example.androidmusicplayer.extension.isAppInstalledOnSDCard
import com.example.androidmusicplayer.extension.isPathOnOTG
import com.example.androidmusicplayer.extension.isPathOnSD
import com.example.androidmusicplayer.extension.isRecycleBinPath
...
import com.example.androidmusicplayer.extension.isSDCardSetAsDefaultStorage
import com.example.androidmusicplayer.extension.isUsingGestureNavigation
import com.example.androidmusicplayer.extension.navigationBarHeight
import com.example.androidmusicplayer.extension.needsStupidWritePermissions
import com.example.androidmusicplayer.extension.onApplyWindowInsets
import com.example.androidmusicplayer.extension.openDeviceSettings
...
import com.example.androidmusicplayer.extension.showFileCreateError
import com.example.androidmusicplayer.extension.statusBarHeight
import com.example.androidmusicplayer.extension.storeAndroidTreeUri
import com.example.androidmusicplayer.extension.sumByLong
import com.example.androidmusicplayer.extension.toFileDirItem
import com.example.androidmusicplayer.extension.toast
import com.example.androidmusicplayer.extension.updateOTGPathFromPartition
...
import com.example.androidmusicplayer.helper.CREATE_DOCUMENT_SDK_30
...
import com.example.androidmusicplayer.helper.EXTRA_SHOW_ADVANCED
import com.example.androidmusicplayer.helper.HIGHER_ALPHA
import com.example.androidmusicplayer.helper.MEDIUM_ALPHA
import com.example.androidmusicplayer.helper.NavigationIcon
import com.example.androidmusicplayer.helper.OPEN_DOCUMENT_TREE_FOR_ANDROID_DATA_OR_OBB
import com.example.androidmusicplayer.helper.OPEN_DOCUMENT_TREE_FOR_SDK_30
import com.example.androidmusicplayer.helper.OPEN_DOCUMENT_TREE_OTG
import com.example.androidmusicplayer.helper.OPEN_DOCUMENT_TREE_SD
...
import com.example.androidmusicplayer.helper.REQUEST_CODE_SET_DEFAULT_DIALER
import com.example.androidmusicplayer.helper.SD_OTG_SHORT
import com.example.androidmusicplayer.helper.SELECT_EXPORT_SETTINGS_FILE_INTENT
import com.example.androidmusicplayer.helper.ensureBackgroundThread
import com.example.androidmusicplayer.helper.getConflictResolution
...
import com.example.androidmusicplayer.helper.isUpsideDownCakePlus
import com.example.androidmusicplayer.interfaces.CopyMoveListener
import com.example.androidmusicplayer.myclasses.CopyMoveTask
import com.example.androidmusicplayer.myclasses.FileDirItem
import com.example.androidmusicplayer.myclasses.MyContextWrapper
import java.io.File
...
abstract class BaseCustomActivity : AppCompatActivity() {
    ...
    fun isShowingOTGDialog(path: String): Boolean {
    ...
    fun showOTGPermissionDialog(path: String) {
        runOnUiThread {
    ...
    fun isShowingSAFDialog(path: String): Boolean {
        ...
        return if (isAccessibleWithSAFSdk30(path) && !hasProperStoredFirstParentUri(path)) {
            runOnUiThread {
                if (!isDestroyed && !isFinishing) {
                    ...
                    WritePermissionDialog(this, WritePermissionDialog.WritePermissionDialogMode.OpenDocumentTreeSDK30(path.getFirstParentPath(this, level))) {
                        Intent(Intent.ACTION_OPEN_DOCUMENT_TREE).apply {
                            putExtra(EXTRA_SHOW_ADVANCED, true)
    ...
    fun getFileOutputStream(fileDirItem: FileDirItem, allowCreatingNewFile: Boolean = false, callback: (outputStream: OutputStream?) -> Unit) {
    ...
    private fun createCasualFileOutputStream(activity: BaseCustomActivity, targetFile: File): OutputStream? {
    ...
    fun isShowingAndroidSAFDialog(path: String): Boolean {
    ...
    fun isShowingSAFCreateDocumentDialogSdk30(path: String): Boolean {
        return if (!hasProperStoredDocumentUriSdk30(path)) {
            runOnUiThread {
                if (!isDestroyed && !isFinishing) {
                    WritePermissionDialog(this, WritePermissionDialog.WritePermissionDialogMode.CreateDocumentSDK30) {
                        Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
