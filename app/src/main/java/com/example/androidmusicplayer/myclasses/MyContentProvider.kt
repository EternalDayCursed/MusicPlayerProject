...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.example.androidmusicplayer.provider"
        const val SHARED_THEME_ACTIVATED = "com.example.androidmusicplayer.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.example.androidmusicplayer.SHARED_THEME_UPDATED"
