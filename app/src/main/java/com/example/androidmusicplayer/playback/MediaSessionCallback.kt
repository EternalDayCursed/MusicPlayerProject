...
import com.example.androidmusicplayer.extension.addRemainingMediaItems
...
import com.example.androidmusicplayer.playback.player.updatePlaybackState
...
@UnstableApi
internal fun PlaybackService.getMediaSessionCallback() = object : MediaLibraryService.MediaLibrarySession.Callback {
