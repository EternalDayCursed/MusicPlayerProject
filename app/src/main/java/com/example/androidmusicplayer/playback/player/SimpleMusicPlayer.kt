...
import com.example.androidmusicplayer.extension.maybeForceNext
import com.example.androidmusicplayer.extension.maybeForcePrevious
import com.example.androidmusicplayer.extension.move
...
class SimpleMusicPlayer(private val exoPlayer: ExoPlayer) : ForwardingPlayer(exoPlayer) {
    ...
    fun setShuffleIndices(indices: IntArray) {
        val shuffleOrder = ShuffleOrder.DefaultShuffleOrder(indices, DEFAULT_SHUFFLE_ORDER_SEED)
