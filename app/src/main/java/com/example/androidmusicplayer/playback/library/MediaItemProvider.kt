package com.example.androidmusicplayer.playback.library
...
import com.example.androidmusicplayer.extension.buildMediaItem
import com.example.androidmusicplayer.extension.isTabVisible
...
internal class MediaItemProvider(private val context: Context) {
    ...
    fun getRecentItemsLazily(callback: (itemsWithStartPosition: MediaSession.MediaItemsWithStartPosition) -> Unit) {
    ...
    fun getRecentItemsWithStartPosition(): MediaSession.MediaItemsWithStartPosition {
        ...
        return MediaSession.MediaItemsWithStartPosition(recentItems, startIndex, startPosition)
    }
...
private enum class RootCategories(@StringRes val titleRes: Int, @DrawableRes val drawableRes: Int, val mediaId: String, val mediaType: @MediaMetadata.MediaType Int) {
